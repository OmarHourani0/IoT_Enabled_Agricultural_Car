...
def create_gui(ser):
    ...
    def key_handler(event):
        if event.keysym == "Up":
            ...
            send_action("R")
        elif event.keysym == "s":  # Bind 's' for Servo Motor
            send_action("S")
        elif event.keysym == "o":  # Bind 'o' for Turn LED On
            send_action("O")
        elif event.keysym == "x":  # Bind 'x' for Stop
            send_action("X")
    ...
    root.bind("s", key_handler)
    root.bind("o", key_handler)
